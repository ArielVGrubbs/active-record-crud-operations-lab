# Replace the '#testing 123' in the below methods to to make the specs pass!
# Each '#testing 123' corresponds to a single line of code you will need to write.
# See the example below on the left and how it should look on the right.
# def make_a_new_movie_instance    # def make_a_new_movie_instance
#   movie = #testing 123                     #   movie = Movie.new
# end                              # end
